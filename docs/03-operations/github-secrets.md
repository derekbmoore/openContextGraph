...
This document outlines all required GitHub secrets for CI/CD deployment of the CtxEco platform.
...
| Secret Name | Description | How to Get |
|------------|-------------|------------|
| `AZURE_KEY_VAULT_URL` | Key Vault URI (e.g., `https://ctxEco-env-kv.vault.azure.net/`) | From Azure Portal or Bicep output |
...
| `API_URL` | Backend API URL (e.g., `https://ctxEco-api.azurecontainerapps.io`) | From Container App FQDN |
| `WS_URL` | WebSocket URL (same as API_URL but `ws://` or `wss://`) | From Container App FQDN |
| `TEMPORAL_HOST` | Temporal gRPC endpoint (e.g., `temporal-server.ctxEco-env-aca.region.azurecontainerapps.io:7233`) | From Temporal Container App |
...
1. Go to your repository: `https://github.com/derekbmoore/opencontextgraph`
...
gh secret set AZURE_KEY_VAULT_URL --body "https://ctxEco-env-kv.vault.azure.net/"
gh secret set API_URL --body "https://ctxEco-api.azurecontainerapps.io"
gh secret set WS_URL --body "wss://ctxEco-api.azurecontainerapps.io"
gh secret set TEMPORAL_HOST --body "temporal-server.ctxEco-env-aca.eastus.azurecontainerapps.io:7233"
```
