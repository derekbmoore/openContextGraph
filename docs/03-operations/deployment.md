...
This guide covers deploying the CtxEco platform to Azure and local development setup.
...
docker build -t ghcr.io/derekbmoore/opencontextgraph/backend:latest ./backend
docker build -t ghcr.io/derekbmoore/opencontextgraph/worker:latest -f ./backend/workflows/Dockerfile ./backend

docker push ghcr.io/derekbmoore/opencontextgraph/backend:latest
docker push ghcr.io/derekbmoore/opencontextgraph/worker:latest
