...
**Endpoint(s):** Remote managed MCP servers via OAuth (catalog) + deploy-your-own guide  
...
## 1) Summary
Great benchmark for OAuth, managed remote, and deployment guidance.
...
|---|---|---|---:|---|
| https://developers.cloudflare.com/agents/model-context-protocol/mcp-servers-for-cloudflare/ | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| https://github.com/cloudflare/mcp-server-cloudflare | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
