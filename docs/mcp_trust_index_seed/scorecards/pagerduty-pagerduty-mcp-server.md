...
**Endpoint(s):** Local server (STDIO); connects to PagerDuty account  
...
## 1) Summary
Strong enterprise incident mgmt use case; repo includes security and license details.
...
|---|---|---|---:|---|
| https://support.pagerduty.com/main/docs/pagerduty-mcp-server-integration-guide | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| https://github.com/PagerDuty/pagerduty-mcp-server | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
