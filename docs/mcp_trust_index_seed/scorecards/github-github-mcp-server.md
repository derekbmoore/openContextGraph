...
**Endpoint(s):** Depends on deployment; typically STDIO/local transport  
...
## 1) Summary
Official GitHub MCP server; enterprise relevance for code, issues, PR automation.
...
|---|---|---|---:|---|
| https://github.com/github/github-mcp-server | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| https://github.com/github/github-mcp-server | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
