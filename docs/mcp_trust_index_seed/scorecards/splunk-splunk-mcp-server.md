...
**Endpoint(s):** Managed remote (see offer docs); supports Splunk Enterprise & Cloud  
...
## 1) Summary
Microsoft Marketplace listing; strong enterprise anchor for audit/ops use cases.
...
|---|---|---|---:|---|
| https://marketplace.microsoft.com/hi-in/product/saas/splunk.splunk_mcp_server?tab=overview | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| (vendor-managed; see offer + Splunk docs) | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
