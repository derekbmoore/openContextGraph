...
**Endpoint(s):** Remote MCP server (preview) per Datadog docs  
...
## 1) Summary
Good for scoring auth posture + logging and guardrails patterns.
...
|---|---|---|---:|---|
| https://docs.datadoghq.com/bits_ai/mcp_server/ | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| (vendor-managed; docs + blog) | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
