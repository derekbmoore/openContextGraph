...
**Provider:** Notion  
**Server / Product:** Notion MCP (hosted) / Notion MCP Server (official)  
**Endpoint(s):** Hosted server (per Notion docs) + HTTP transport option in official server repo  
...
## 1) Summary
Shows both hosted and self-run patterns; includes HTTP transport with auth token options.
...
|---|---|---|---:|---|
| https://developers.notion.com/docs/mcp | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| https://github.com/makenotion/notion-mcp-server | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
