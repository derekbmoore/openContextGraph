...
**Endpoint(s):** (see Celonis asset docs; depends on customer Celonis environment)  
...
## 1) Summary
Direct comparator for 'graph-shaped' differentiation (PI Graph context).
...
|---|---|---|---:|---|
| https://developer.celonis.com/mcp-server-asset/overview/ | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| (vendor docs) | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
