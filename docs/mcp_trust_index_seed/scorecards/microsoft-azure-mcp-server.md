...
**Endpoint(s):** Local server; connects via MCP client (e.g., VS Code/GitHub Copilot).  
...
## 1) Summary
Official Microsoft repo includes Azure MCP; important benchmark for auth/RBAC guidance.
...
|---|---|---|---:|---|
| https://learn.microsoft.com/en-us/azure/developer/azure-mcp-server/ | Docs | 2026-01-22 | 1 | Primary documentation / listing |
| https://github.com/microsoft/mcp | Repo / Source | 2026-01-22 | 1 | If OSS; otherwise N/A |
