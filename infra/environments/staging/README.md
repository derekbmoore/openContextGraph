...
3. Resource group created: `rg-ctxEco-staging`
...
az deployment group create \
  --resource-group rg-ctxEco-staging \
...
az containerapp list --resource-group rg-ctxEco-staging

# Check PostgreSQL
az postgres flexible-server show \
  --resource-group rg-ctxEco-staging \
  --name ctxEco-staging-db

# Check Storage Account
az storage account show \
  --resource-group rg-ctxEco-staging \
  --name ctxEcostagingstore
```
